...
export default function SettingsDetailsChencelor({ navigation }: { navigation: any }) {
    ...
    useEffect(() => {
        const fetchUserDetails = async () => {
          ...
          try {
            const response = await fetch(url + 'deans/fetch/myData', {
              method: 'GET',
              headers: {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await fetch(url + `deans/${userDetails.dean_id}`, {
