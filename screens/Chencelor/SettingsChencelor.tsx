...
export default function SettingsChencelor({navigation}){
    return (
        <ScrollView className='w-full'>

        <View className='flex flex-col'>
              <View className='py-4 px-5 bg-white border-b border-gray-200'>
                <TouchableOpacity onPress={() => navigation.navigate('SettingsDetailsDean')} className='flex flex-row justify-end gap-x-3'>
