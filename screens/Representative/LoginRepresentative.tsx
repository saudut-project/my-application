...
export default function LoginRepresentative({ navigation }: { navigation: any }) {
    const [username, setUsername] = useState('');
    const [password, setPassword] = useState('');
    const userType = 'representative'; // Assuming the user type is fixed for this component
    const handleLogin = async () => {
        try {
            ...
            if (response.ok) {
                ...
                navigation.navigate('DashboardRepresentative');
