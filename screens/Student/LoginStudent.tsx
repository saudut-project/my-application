...
export default function LoginStudent({ navigation }: { navigation: any }) {
    const [username, setUsername] = useState('');
    const [password, setPassword] = useState('');
    const userType = 'student'; // Assuming the user type is fixed for this component
    ...
    return (
        <View className='flex flex-col min-h-screen bg-[#fff]'>
        ...
        <View className="flex flex-col min-h-screen items-center justify-center">
            <View>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('RegisterStudent')} className="bg-indigo-500 mt-4 text-white py-3 px-4 rounded-full">
                    <Text className="text-white text-center font-cairo">
                        تسجيل جديد 
                    </Text>
                </TouchableOpacity>
