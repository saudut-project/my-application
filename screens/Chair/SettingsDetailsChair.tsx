...
export default function SettingsDetailsChair({ navigation }: { navigation: any }) {
    ...
    useEffect(() => {
        const fetchUserDetails = async () => {
          ...
          try {
            const response = await fetch(url + 'chairpersons/fetch/myData', {
              method: 'GET',
              headers: {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await fetch(url + `chairpersons/update/my/password`, {
