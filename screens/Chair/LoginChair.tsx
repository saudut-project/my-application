...
export default function LoginChair({ navigation }: { navigation: any }) {
    const [username, setUsername] = useState('');
    const [password, setPassword] = useState('');
    const userType = 'chairperson'; // Assuming the user type is fixed for this component
    const handleLogin = async () => {
        try {
            ...
            if (response.ok) {
                ...
                navigation.navigate('DashboardChair');
    ...
    return (
        ...
        <View className="flex flex-col min-h-screen items-center justify-center">
            <View>
                ...
                <TextInput
                    className='bg-white text-black w-[200px] rounded-xl 
